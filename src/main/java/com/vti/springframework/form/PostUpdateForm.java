...
public class PostUpdateForm {
    @NotBlank(message = "Post title must not believe blank")
    @Length(max = 50, message = "Post title has max 50 characters")
    private String title;

    @NotBlank(message = "Post description must not believe blank")
    @Length(max = 100, message = "Post description has max 100 characters")
    private String description;

    @NotBlank(message = "Post content must not believe blank")
